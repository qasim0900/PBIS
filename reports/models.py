...
"""
Defines export file formats as a Django `TextChoices` enumeration with options PDF and CSV.
"""
...
"""
Django model representing archived reports of inventory counts, storing metadata, export format, optional URL, snapshot of contents, submission info, and timestamps.
"""
...
class ReportArchive(models.Model):
    ...
    export_format = models.CharField(
        max_length=8, choices=ExportFormat.choices, default=ExportFormat.PDF)
    ...
    payload_snapshot = models.JSONField(
        ...
        blank=True,
        help_text=_(
            "Lightweight snapshot of the export contents for quick reference."),
    )
