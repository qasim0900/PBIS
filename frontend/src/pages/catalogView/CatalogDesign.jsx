...
//-----------------------------------
// :: Catalog Design Function
//-----------------------------------

/*
This React component renders an inventory catalogue with a searchable table and a modal 
                ...
                <DialogContent dividers>
                    <Box display="grid" gridTemplateColumns="1fr 1fr" gap={2} mt={1}>
                        ...
                        <TextField select label="Frequency" value={formData.frequency}
                            ...
                            {frequencies.map((f) => (
                                <MenuItem key={f.id} value={f.id}>{f.common_frequency}</MenuItem>
                            ))}
                        </TextField>
